class Computer < ActiveRecord::Base
  ...
  has_many :managed_install_reports# TODO:, order: 'created_at DESC'
  ...
  validates_format_of :mac_address, :with => /\A([0-9a-f]{2}(:|$)){6}\z/ # mac_address attribute must look something like ff:12:ff:34:ff:56
