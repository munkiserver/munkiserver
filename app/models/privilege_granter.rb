module PrivilegeGranter
  ...
  def read_system_permissions(_unit_ids)
    can [:read, :edit], Permission, unit_id: nil
  end

  def modify_system_permissions(_unit_ids)
  ...
  # = Users =
  # =========
  def read_users(_unit_ids)
    can :read, User
  end

  def modify_users(_unit_ids)
    can :update, User
  end

  def create_users(_unit_ids)
    can :create, User
  end

  def destroy_users(_unit_ids)
    can :destroy, User
  end
  ...
  # = Units =
  # =========
  def read_units(_unit_ids)
    can :read, Unit
  end

  def modify_units(_unit_ids)
    can :update, Unit
  end

  def create_units(_unit_ids)
    can :create, Unit
  end

  def destroy_units(_unit_ids)
    can :destroy, Unit
  end
